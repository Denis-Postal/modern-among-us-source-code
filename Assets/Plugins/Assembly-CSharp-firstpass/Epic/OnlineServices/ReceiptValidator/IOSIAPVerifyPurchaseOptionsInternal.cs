...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct IOSIAPVerifyPurchaseOptionsInternal : ISettable<IOSIAPVerifyPurchaseOptions>, IDisposable
	{
		...
		public IOSIAPVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
