...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct SwitchIAPVerifyPurchaseOptionsInternal : ISettable<SwitchIAPVerifyPurchaseOptions>, IDisposable
	{
		...
		public SwitchIAPVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
