...
namespace Epic.OnlineServices.Platform
{
	...
	internal struct XboxOneGDKInitializeOptionsInternal : ISettable<XboxOneGDKInitializeOptions>, IDisposable
	{
		...
		public XboxOneGDKInitializeOptionsSystemInitializeOptions? SystemInitializeOptions
		{
			set
			{
			}
