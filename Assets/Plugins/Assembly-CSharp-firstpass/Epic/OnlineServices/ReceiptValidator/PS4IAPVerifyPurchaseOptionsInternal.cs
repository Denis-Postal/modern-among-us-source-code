...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct PS4IAPVerifyPurchaseOptionsInternal : ISettable<PS4IAPVerifyPurchaseOptions>, IDisposable
	{
		...
		public PS4IAPVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
