...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct SteamDLCVerifyPurchaseOptionsInternal : ISettable<SteamDLCVerifyPurchaseOptions>, IDisposable
	{
		...
		public SteamDLCVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
