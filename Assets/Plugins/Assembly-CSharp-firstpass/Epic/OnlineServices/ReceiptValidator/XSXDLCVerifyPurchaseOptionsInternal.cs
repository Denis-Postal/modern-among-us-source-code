...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct XSXDLCVerifyPurchaseOptionsInternal : ISettable<XSXDLCVerifyPurchaseOptions>, IDisposable
	{
		...
		public XSXDLCVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
