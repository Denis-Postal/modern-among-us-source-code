...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct XboxOneGDKDLCVerifyPurchaseOptionsInternal : ISettable<XboxOneGDKDLCVerifyPurchaseOptions>, IDisposable
	{
		...
		public XboxOneGDKDLCVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
