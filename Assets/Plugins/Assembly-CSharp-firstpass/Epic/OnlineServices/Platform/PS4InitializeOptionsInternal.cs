...
namespace Epic.OnlineServices.Platform
{
	...
	internal struct PS4InitializeOptionsInternal : ISettable<PS4InitializeOptions>, IDisposable
	{
		...
		public PS4InitializeOptionsSystemInitializeOptions? SystemInitializeOptions
		{
			set
			{
			}
