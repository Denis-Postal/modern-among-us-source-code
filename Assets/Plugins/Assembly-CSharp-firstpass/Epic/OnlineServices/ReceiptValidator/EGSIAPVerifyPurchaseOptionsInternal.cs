...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct EGSIAPVerifyPurchaseOptionsInternal : ISettable<EGSIAPVerifyPurchaseOptions>, IDisposable
	{
		...
		public EGSIAPVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
