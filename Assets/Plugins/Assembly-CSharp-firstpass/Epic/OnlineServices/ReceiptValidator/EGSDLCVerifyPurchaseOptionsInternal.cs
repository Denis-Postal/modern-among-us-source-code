...
namespace Epic.OnlineServices.ReceiptValidator
{
	...
	internal struct EGSDLCVerifyPurchaseOptionsInternal : ISettable<EGSDLCVerifyPurchaseOptions>, IDisposable
	{
		...
		public EGSDLCVerifyPurchaseOptionsPlatformSpecificOptions? PlatformSpecificOptions
		{
			set
			{
			}
